...
export default function Hero() {
  ...
  // Form Submit Logic: Redirects to WhatsApp with Form Data
  const handleSubmit = (e) => {
    e.preventDefault();
    const text = `*New Enquiry from Dazzling Villa website*%0A%0A` +
  ...
  return (
    ...
    >
      {/* Overlay - Ensuring it doesn't block pointer events for buttons underneath */}
      ...
      {showForm && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-[#0D130D] border border-white/10 p-8 md:p-10 shadow-2xl animate-in fade-in zoom-in duration-300">
            <button 
              onClick={() => setShowForm(false)}
            ...
            <div className="text-center mb-8">
              <span className="text-[#C9A24D] uppercase tracking-[0.4em] text-[10px] mb-2 block font-medium">Reservation</span>
              <h2 className="text-3xl font-serif italic text-white font-light">Enquiry Form</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-b border-white/20 py-3 pl-8 text-[12px] text-white tracking-[0.2em] focus:outline-none focus:border-[#C9A24D] transition-colors placeholder:text-white/40 uppercase"
                  required
                />
              </div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-b border-white/20 py-3 pl-8 text-[12px] text-white tracking-[0.2em] focus:outline-none focus:border-[#C9A24D] transition-colors placeholder:text-white/40"
                  required
                />
              </div>
              ...
              <div className="relative">
                ...
                <textarea 
                  ...
                  className="w-full bg-transparent border-b border-white/20 py-3 pl-8 text-[12px] text-white tracking-[0.2em] focus:outline-none focus:border-[#C9A24D] transition-colors placeholder:text-white/40 resize-none uppercase"
                ></textarea>
              </div>

              <button type="submit" className="w-full mt-6 py-4 bg-[#C9A24D] text-black text-[11px] uppercase tracking-[0.5em] font-bold hover:bg-white transition-all duration-500">
                Send via WhatsApp <Send size={14} className="inline ml-2" />
              </button>
            </form>
          </div>
        </div>
      ...
      {/* WHATSAPP CONCIERGE BUTTON - High Z-index */}
      <div className="fixed bottom-8 right-8 z-[99999]">
        ...
        >
          {/* Label Card */}
          <div className="mr-4 bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl opacity-0 translate-x-10 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 shadow-2xl">
            <div className="px-5 py-3 flex flex-col items-end whitespace-nowrap">
              <span className="text-[#C9A24D] text-[9px] uppercase tracking-[0.3em] font-semibold">Concierge</span>
              <span className="text-white text-sm font-serif italic">Nishanth</span>
            </div>
          </div>

          {/* WhatsApp Icon */}
          <div className="relative bg-[#25D366] p-4 rounded-full shadow-[0_15px_35px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform duration-300">
